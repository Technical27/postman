...
impl Post {
    pub fn new(author: &str, title: &str, image: &str, permalink: &str, nsfw: bool) -> Self {
        Self { author: author.to_string(), title: title.to_string(), image: image.to_string(), permalink: permalink.to_string(), nsfw }
    }
...
mod test {
    ...
    fn post_author_url() {
        ...
        assert_eq!(post.author_url(), "https://reddit.com/u/Technical27".to_string());
    }
